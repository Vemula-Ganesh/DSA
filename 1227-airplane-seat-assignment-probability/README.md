<h2><a href="https://leetcode.com/problems/airplane-seat-assignment-probability/?envType=problem-list-v2&envId=probability-and-statistics">1362. Airplane Seat Assignment Probability</a></h2><h3>Medium</h3><hr><p><code>n</code> passengers board an airplane with exactly <code>n</code> seats. The first passenger has lost the ticket and picks a seat randomly. But after that, the rest of the passengers will:</p>
